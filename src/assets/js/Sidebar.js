...
Sidebar.prototype.init = function()
{
	...
	//this.addImagePalette('clipart', mxResources.get('clipart'), dir + '/ha/', '_128x128.png',
...
///////////PALETTES AVEC LES EQUIPEMENTS INDOOR ////////////////////////////////


////Antennes
		  this.addImagePalette('Antennes','Antennes', dir +'/Antennes/','_128x128.png',
		  ['Omni_Antenna','Omni_Antenna_Indoor','Panel_Antenna','Panel_Antenna_Indoor'], null,
		   {'Wireless_Router_N': 'wireless router switch wap wifi access point wlan',
			'Router_Icon': 'router switch'});

			/////Connecteurs

			this.addImagePalette('Connecteurs','Connecteurs', dir +'/Connecteurs/','_128x128.png',
		  ['Connecteur_frog'], null,
		   {'Wireless_Router_N': 'wireless router switch wap wifi access point wlan',
			'Router_Icon': 'router switch'});

			//Feeders

			this.addImagePalette('Feeders','Feeders', dir +'/Feeders/','_128x128.png',
		  ['Feeder_cable_12','Feeder_cable_78'], null,
		   {'Wireless_Router_N': 'wireless router switch wap wifi access point wlan',
			'Router_Icon': 'router switch'});

			//Jumpers

			this.addImagePalette('Jumpers','Jumpers', dir +'/Jumpers/','_128x128.png',
		  ['Jumper_frog_0_5m','Jumper_frog_1m'], null,
		   {'Wireless_Router_N': 'wireless router switch wap wifi access point wlan',
			'Router_Icon': 'router switch'});

			//Splitters

			this.addImagePalette('Splitters','Splitters', dir +'/Splitters/','_128x128.png',
		  ['Splitter_frog'], null,
		   {'Wireless_Router_N': 'wireless router switch wap wifi access point wlan',
			'Router_Icon': 'router switch'});
			...
			this.addImagePalette('UPs','UPs', dir +'/UPs/','_128x128.png',
		  ['Back_Up_frog'], null,
		   {'Wireless_Router_N': 'wireless router switch wap wifi access point wlan',
			'Router_Icon': 'router switch'});
